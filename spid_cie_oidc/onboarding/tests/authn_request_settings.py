...
AUTHN_REQUEST_SPID_NO_CORRECT_SCOPE["scope"] = ["idopen"]
...
AUTHN_REQUEST_SPID_NO_CORRECT_ACR_VALUES["acr_values"] = ["https://www.spid.gov.it/SpidL4", "https://www.spid.gov.it/SpidL1"]
