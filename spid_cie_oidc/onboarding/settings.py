...
JWS_ALG = getattr(
    settings, "DEFAULT_JWS_ALG", entity_settings.DEFAULT_JWS_ALG
)
DEFAULT_JWE_ALG = getattr(
    settings, "DEFAULT_JWE_ALG", entity_settings.DEFAULT_JWE_ALG
)
JWE_ENC = getattr(
    settings, "DEFAULT_JWE_ENC", entity_settings.DEFAULT_JWE_ENC
)
...
FEDERATION_DEFAULT_POLICY = {
    "openid_provider": {
      ...
      # "organization_name": {
        # "value": "SPID OIDC Identity Provider"
      # },
