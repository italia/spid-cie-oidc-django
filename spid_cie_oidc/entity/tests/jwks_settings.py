...
JWKS_WITH_N_AND_EC_NO_CORRECT["keys"][0]["n"] = "iu4ZgxlozJEXgTGUFuuDl7o8b_8JnMswwddaQjhFkKk"

JWKS_WITH_X_AND_RSA_NO_CORRECT = deepcopy(JWKS)
JWKS_WITH_X_AND_RSA_NO_CORRECT["keys"][0]["x"] = "iu4ZgxlozJEXgTGUFuuDl7o8b_8JnMswwddaQjhFkKk"
