...
op_conf = {
    ...
    'metadata': {'openid_provider': {'authorization_endpoint': 'http://op-test/oidc/op/authorization',
    ...
    'acr_values_supported': ['https://www.spid.gov.it/SpidL1',
        'https://www.spid.gov.it/SpidL2',
        'https://www.spid.gov.it/SpidL3'],
    'claims_supported': ['https://attributes.spid.gov.it/spidCode',
